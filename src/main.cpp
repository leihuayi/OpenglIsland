...
void drawSky()
{
    ...
    glBegin(GL_QUADS);
    glTexCoord2f(0.0f, 3.0f); glVertex3f(-1.0f, -0.5f, -1.0f);  // Top Right Of The Texture and Quad
    glTexCoord2f(0.0f, 0.0f); glVertex3f( 1.0f, -0.5f, -1.0f);  // Top Left Of The Texture and Quad
    glTexCoord2f(3.0f, 0.0f); glVertex3f( 1.0f, -0.5f,  1.0f);  // Bottom Left Of The Texture and Quad
    glTexCoord2f(3.0f, 3.0f); glVertex3f(-1.0f, -0.5f,  1.0f);  // Bottom Right Of The Texture and Quad
    glEnd();
...
void init (void) {
    ...
    glLoadIdentity();
    gluLookAt(0.0, -30.0, 0.0, 0.0, -30.0, 1.0, 0.0, 1.0, 0.0);

    // load an image file directly as a new OpenGL texture
    //texSnow = loadTexture("../images/snowflake.png");
